...
<head>
    ...
    <title>KP BOS | Bureau Of Statistics </title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.6 -->
    <link rel="stylesheet" href="{{ URL::asset('public/admin/bootstrap/css/bootstrap.min.css') }}" href="">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet"  href="{{ URL::asset('public/admin/dist/css/AdminLTE.min.css') }}" href="">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet"  href="{{ URL::asset('public/admin/dist/css/skins/_all-skins.min.css') }}" href="" href="">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ URL::asset('public/admin/plugins/iCheck/flat/blue.css') }}"  href="">
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ URL::asset('public/admin/plugins/morris/morris.css') }}" href="">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{ URL::asset('public/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css') }}" href="">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{ URL::asset('public/admin/plugins/datepicker/datepicker3.css') }}" href="">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ URL::asset('public/admin/plugins/daterangepicker/daterangepicker.css') }}" href="">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="{{ URL::asset('public/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}" href="">
...
<a href="index2.html" class="logo">
    ...
    <span class="logo-mini"><b>KP BOS</b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>KP BOS</b></span>
</a>
        ...
        <!-- <li> -->
            ...
            <!-- <ul class="menu">
                <li>
                    ...
                    <a href="#">
                        <div class="pull-left">
                            <img  src="{{ asset('public/admin/dist/img/user2-160x160.jpg') }}" src="" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                            Support Team
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="{{ url('categories') }}">
                    <i class="fa fa-dashboard"></i> <span>Sectors</span>
                </a>
            </li>
            ...
            <li class="treeview">
                <a href="{{ url('publications_uploads') }}">
                    <i class="fa fa-dashboard"></i> <span>Publication Management</span>
                </a>
            </li>
            ...
            <li class="treeview">
                <a href="{{ url('organization_hierarchy') }}">
                    <i class="fa fa-dashboard"></i> <span>Organization Hierarchy</span>
                </a>
            </li>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="{{URL::to('/')}}">KHYBER PAKHTUNKHWA BEAURAU OF STATISTICS</a>.</strong> All rights
    reserved.
</footer>
