    ...
    <div class="modal-dialog" style="width: 1000px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('organization_hierarchy') }}" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="designation" required="required" ><br>

                    <label>Contact Information:</label>
                    <input type="text" class="form-control" name="contact_no" required="required" ><br>
...
<div class="modal fade" id="edit_member" role="dialog">
    <div class="modal-dialog" style="width: 1000px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('edit_member') }}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="<?php echo csrf_token() ?>">
                    <input type="hidden" name="id" id="id">
                    <label>Name:</label>
                    <input type="text" id="name" class="form-control" name="name" required="required" ><br>

                    <label>Designation:</label>
                    <input type="text" id="designation" class="form-control" name="designation" required="required" ><br>

                    <label>Contact Information:</label>
                    <input type="text" id="contact_no" class="form-control" name="contact_no" required="required" ><br>
...
<script>
    $(document).ready(function(){
        $('.edit').on('click',function(){
            ...
            $.get('{{ url("organization_hierarchy") }}/'+id+'/edit',function(response){
                $('#section_image').empty();
                $.each(response,function(key,value){
                    $('#id').val(value.id);
                    $('#name').val(value.name);
                    $('#designation').val(value.designation);
                    $('#section_image').append('<img style="width: 150px; height: 150px;" src="public/uploads/members'+'/'+ value.pic +'">');
