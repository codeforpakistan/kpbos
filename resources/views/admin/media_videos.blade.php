    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border" >
                ...
                <button type="sm-button" class="btn btn-primary " data-toggle="modal" data-target="#addnews" style="margin-left: 25em; float: right; height: 30px;"><i class="fa fa-plus fa-fw"></i>Add Video</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="col-md-2" style="margin-left: 13px;">
                                <form action="{{ url('media',$video->id) }}" method="post">
                                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
